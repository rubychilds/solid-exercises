...
public class ConfidentialPhrases
{
  ...
  public final static ConfidentialPhraseCategory MailingAddress = new ConfidentialPhraseCategory(79,
                                                                                                 "MailingAddress",
                                                                                                 ConfidentialPhraseCategoryType.CONTACT);
  public final static ConfidentialPhraseCategory PhoneNumber    = new ConfidentialPhraseCategory(78,
                                                                                                 "PhoneNumber",
                                                                                                 ConfidentialPhraseCategoryType.CONTACT);
  public final static ConfidentialPhraseCategory EmailAddress   = new ConfidentialPhraseCategory(77,
                                                                                                 "EmailAddress",
                                                                                                 ConfidentialPhraseCategoryType.CONTACT);
  public final static ConfidentialPhraseCategory ContactInfo    = new ConfidentialPhraseCategory(80,
                                                                                                 "ContactInfo",
                                                                                                 ConfidentialPhraseCategoryType.CONTACT);
